                ...
                {[
                    {
                        ...
                        label: "Understand",
                        description:
                            "We map what learners and families need most.",
                    },
                    {
                        step: "02",
                        label: "Build",
                        description:
                            "Features designed around real dyslexia journeys.",
                    },
                    {
                        step: "03",
                        label: "Launch",
                        description:
                            "Rolled out thoughtfully, not rushed to market.",
                    },
                ].map(({ step, label, description }) => (
                    <div
                        key={step}
                        className="rounded-2xl border border-border bg-brand-card p-6 text-left"
                    >
