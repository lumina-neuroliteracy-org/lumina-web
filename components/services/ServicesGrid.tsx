...
const services: Service[] = [
  {
    ...
    priceNote: "no charge",
    bookingHref:
      "https://tidycal.com/104qe7v/free-15-minute-screening-and-needs-assessment",
  },
  {
    icon: ClipboardList,
    ...
    disclaimer:
      "This is a literacy screening/placement assessment designed to identify learning gaps and inform instruction. It is not a clinical diagnosis.",
  },
  {
    icon: GraduationCap,
    ...
    bookingHref:
      "https://tidycal.com/104qe7v/monthly-dyslexia-tutor-membership",
    priceTiers: [
      {
      ...
      },
      {
        ...
        total: "€110",
        perSession: "€55 each",
        bookingHref: "https://tidycal.com/104qe7v/one-on-one-2-sessions",
      },
      {
      ...
      },
      {
        ...
        perSession: "€45 each",
        bookingHref:
          "https://tidycal.com/104qe7v/individual-dyslexia-tutoring-session-3-sessions",
      },
    ],
  },
  {
            ...
            <article className="flex h-full flex-col rounded-[2rem] border border-border bg-brand-card p-8 shadow-sm">
              ...
              <div className="mt-6 space-y-4">
                {service.priceTiers ? (
                  <div>
                    ...
                    <div className="divide-y divide-border rounded-xl border border-border overflow-hidden">
                      {service.priceTiers.map((tier) => (
                        <div
                          key={tier.label}
                          className="flex items-center justify-between gap-3 bg-background px-3 py-3 text-sm"
                        >
                          <div>
                            <p className="text-brand-muted">{tier.label}</p>
                  ...
                  <div>
                    <p
                      className={`text-2xl font-semibold ${service.price === "Free" ? "text-emerald-600" : "text-brand-navy"}`}
                    >
                      {service.price}
                    </p>
               ...
               {!service.priceTiers &&
    (service.bookingHref || service.whatsappMessage) && (
